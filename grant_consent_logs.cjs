...
const sql = `
GRANT ALL ON public.user_consent_logs TO authenticated;
GRANT ALL ON public.user_consent_logs TO service_role;
GRANT ALL ON public.user_consent_logs TO anon;
...
async function executeSql() {
    ...
    if (!resp.ok) {
        ...
        console.log('Permissions updated. Status:', resp.status);
    }
}
